...
// (12:6) {#if activeItem === i}
function create_if_block(ctx) {
	let div;
	let raw_value = /*item*/ ctx[13].description + "";
	let div_transition;
	let current;
	...
	return {
		...
		h() {
			attr(div, "class", "description svelte-13dspl7");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if ((!current || dirty & /*items*/ 2) && raw_value !== (raw_value = /*item*/ ctx[13].description + "")) div.innerHTML = raw_value;		},
		i(local) {
			if (current) return;
...
function create_each_block(key_1, ctx) {
	...
	let if_block = /*activeItem*/ ctx[2] === /*i*/ ctx[15] && create_if_block(ctx);
	...
	return {
		...
		h() {
			attr(span0, "class", "svelte-13dspl7");
			attr(span1, "class", "icon svelte-13dspl7");
			attr(button, "class", "svelte-13dspl7");
			attr(div1, "class", "item svelte-13dspl7");
			toggle_class(div1, "active", /*activeItem*/ ctx[2] === /*i*/ ctx[15]);
			this.first = div1;
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if ((!current || dirty & /*items*/ 2) && t0_value !== (t0_value = /*item*/ ctx[13].title + "")) set_data(t0, t0_value);

			if (/*activeItem*/ ctx[2] === /*i*/ ctx[15]) {
				if (if_block) {
					if_block.p(ctx, dirty);
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h2, "class", "heading svelte-13dspl7");
			attr(div, "class", "accordion svelte-13dspl7");
			attr(section, "class", "section-container svelte-13dspl7");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('snav' in $$props) $$invalidate(8, snav = $$props.snav);
		if ('nav' in $$props) $$invalidate(9, nav = $$props.nav);
		if ('hhxjt' in $$props) $$invalidate(10, hhxjt = $$props.hhxjt);
		if ('wqdoy' in $$props) $$invalidate(11, wqdoy = $$props.wqdoy);
