...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-69tk0l");
		...
		p(ctx, dirty) {
			...
			if (dirty & /*nav*/ 2 && a_href_value !== (a_href_value = /*link*/ ctx[16].url)) {
...
function create_each_block(ctx) {
	...
	let current;
	icon = new Component$1({ props: { icon: /*icon*/ ctx[17] } });
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*link*/ ctx[16].url);
			attr(a, "aria-label", a_aria_label_value = /*link*/ ctx[16].label);
			attr(a, "class", "svelte-69tk0l");
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty & /*social*/ 1) icon_changes.icon = /*icon*/ ctx[17];
			icon.$set(icon_changes);

			if (!current || dirty & /*social*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[16].url)) {
				attr(a, "href", a_href_value);
			}

			if (!current || dirty & /*social*/ 1 && a_aria_label_value !== (a_aria_label_value = /*link*/ ctx[16].label)) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(nav_1, "class", "svelte-69tk0l");
			attr(a, "href", "https://primo.so");
			attr(a, "class", "svelte-69tk0l");
			attr(span, "class", "primo svelte-69tk0l");
			attr(div, "class", "social-links svelte-69tk0l");
			attr(footer, "class", "section-container svelte-69tk0l");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('snav' in $$props) $$invalidate(5, snav = $$props.snav);
		if ('nav' in $$props) $$invalidate(1, nav = $$props.nav);
		if ('lfbgz' in $$props) $$invalidate(6, lfbgz = $$props.lfbgz);
		if ('clmrm' in $$props) $$invalidate(7, clmrm = $$props.clmrm);
		if ('title' in $$props) $$invalidate(8, title = $$props.title);
		if ('d' in $$props) $$invalidate(9, d = $$props.d);
		if ('ds' in $$props) $$invalidate(10, ds = $$props.ds);
		if ('description' in $$props) $$invalidate(11, description = $$props.description);
		if ('uofkh' in $$props) $$invalidate(12, uofkh = $$props.uofkh);
		if ('bwonf' in $$props) $$invalidate(13, bwonf = $$props.bwonf);
		if ('qoscy' in $$props) $$invalidate(14, qoscy = $$props.qoscy);
		if ('yfwhw' in $$props) $$invalidate(15, yfwhw = $$props.yfwhw);
	};
