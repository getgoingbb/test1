...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-h63pcf");
		...
		p(ctx, dirty) {
			if (dirty & /*nav*/ 4 && t_value !== (t_value = /*link*/ ctx[20].label + "")) set_data(t, t_value);

			if (dirty & /*nav*/ 4 && a_href_value !== (a_href_value = /*link*/ ctx[20].url)) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-h63pcf");
			attr(nav_1, "id", "popup");
			attr(nav_1, "class", "svelte-h63pcf");
		},
		m(target, anchor) {
...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*site_nav*/ 2 && t_value !== (t_value = /*link*/ ctx[20].label + "")) set_data(t, t_value);

			if (dirty & /*site_nav*/ 2 && a_href_value !== (a_href_value = /*link*/ ctx[20].url)) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			nav_1 = claim_element(div0_nodes, "NAV", { class: true });
			var nav_1_nodes = children(nav_1);
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-h63pcf");
			attr(nav_1, "class", "svelte-h63pcf");
			attr(div0, "class", "desktop-nav svelte-h63pcf");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-h63pcf");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-h63pcf");
			attr(div2, "class", "section-container svelte-h63pcf");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('snav' in $$props) $$invalidate(6, snav = $$props.snav);
		if ('nav' in $$props) $$invalidate(2, nav = $$props.nav);
		if ('lfbgz' in $$props) $$invalidate(7, lfbgz = $$props.lfbgz);
		if ('clmrm' in $$props) $$invalidate(8, clmrm = $$props.clmrm);
		if ('title' in $$props) $$invalidate(9, title = $$props.title);
		if ('d' in $$props) $$invalidate(10, d = $$props.d);
		if ('ds' in $$props) $$invalidate(11, ds = $$props.ds);
		if ('description' in $$props) $$invalidate(12, description = $$props.description);
		if ('uofkh' in $$props) $$invalidate(13, uofkh = $$props.uofkh);
		if ('bwonf' in $$props) $$invalidate(14, bwonf = $$props.bwonf);
		if ('qoscy' in $$props) $$invalidate(15, qoscy = $$props.qoscy);
		if ('yfwhw' in $$props) $$invalidate(16, yfwhw = $$props.yfwhw);
	};
